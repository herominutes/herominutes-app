...
Herominutes is a mobile-first progressive web application (PWA) that supports athletes through structured recovery and mobility routines.
...
This public repository contains product overview and documentation only.

The production codebase is maintained in a private repository due to security, privacy, and infrastructure considerations.
